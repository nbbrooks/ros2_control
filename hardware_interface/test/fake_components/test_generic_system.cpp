...
TEST_F(TestGenericSystem, generic_system_2dof_functionality_with_offset_custom_interface) {
  ...
  hardware_interface::LoanedStateInterface c_j1p_s = rm.claim_state_interface(
    "joint1/actual_position");
  hardware_interface::LoanedStateInterface c_j2p_s = rm.claim_state_interface(
    "joint2/actual_position");
